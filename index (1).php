...
<body onload="SwitchScreen()">
        <section class="container">
            ...
            <article class="form-area">
                ...
                <div class="apps">
                    <p>Get the app.</p>
                    <a href="#"> <img src="img/appstore.png" alt="Get app in AppStore"> </a>
                    <a href="#"> <img src="img/googleplay.png" alt="Get app in Google Play"> </a>
                </div>
            </article>
        </section>
            <!-- FORM SECTION END -->
        ...
        <footer>
            ...
            <div class="copyright">
                <select aria-label="Trocar idioma de exibição">
                    ...
                    <option value="en">Português (Portugal)</option>
